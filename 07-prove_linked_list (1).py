...
class LinkedList:
    """
    Implement the LinkedList data structure.  The Node class below is an inner class.  An inner class means that its real name is related to the outer class.  To create a Node object, we will need to specify LinkedList.Node
    """
    ...
    def __reversed__(self):
        ...
        curr = self.tail # Replace this when you implement your solution
        while curr is not None:
            yield curr.data
            curr = curr.prev
    #################
