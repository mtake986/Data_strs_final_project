...
class BST:
    ...
    def _traverse_forward(self, node):
        ...
        sub-tree) exists, numbers first), then we will 
    ...
    def _traverse_backward(self, node):
        ...
        """
        if node is not None:# Replace this when you implement your solution
    ...
    def _get_height(self, node):
        ...
        if node.left is not None:
            print("left")
            i += 1
            self._get_height(node = node.left)
        else:
            i += 1
            mx_lis.append(i)
        ...
        if node.right is not None:
            i += 1
            print('right')
            self._get_height(node = node.right)
        else:
            i += 1
            mx_lis.append(i)
        return mx_lis
